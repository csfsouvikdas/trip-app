...
import { Utensils, Plus, Trash2, Calendar, Clock, ArrowRight, Loader2, Salad } from "lucide-react";
                    ...
                    <div key={dateString} className="space-y-3">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        {dayMeals.map((meal) => (
                          <div
                            key={meal.id}
                            className="flex items-center justify-between gap-3 p-3 bg-neutral-50/50 dark:bg-neutral-900/10 hover:bg-neutral-100/50 dark:hover:bg-neutral-800/10 border border-neutral-100 dark:border-neutral-800/50 rounded-lg group transition-colors"
                          >
                            <div className="space-y-1.5 overflow-hidden">
                              <div className="flex items-center gap-2">
                                <span className={`text-[10px] px-2 py-0.5 border rounded-full font-bold uppercase tracking-wider ${getTimeBadgeStyle(meal.time)}`}>
                                  {meal.time}
                                </span>
                              </div>
